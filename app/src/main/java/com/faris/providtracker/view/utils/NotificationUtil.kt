...
import com.faris.providtracker.view.ui.activity.main.MainActivity
...
class NotificationUtil(base: Context) : ContextWrapper(base) {
    ...
    fun getNotificationBuilder(name: String): NotificationCompat.Builder {
        val intent = Intent(this, MainActivity::class.java).apply {
            flags = Intent.FLAG_ACTIVITY_CLEAR_TASK
        }
        val pendingIntent = PendingIntent.getActivity(this, 0, intent, 0)
        return NotificationCompat.Builder(applicationContext, MYCHANNEL_ID)
            .setContentTitle(getString(R.string.hey_you))
            .setContentText(getString(R.string.do_not_forget, name))
